<?php
$user_codigo_del=limpiar_cadena($_GET['dep_codigo_del']);

//verificando usuario
$check_usuario=conexion();
$check_usuario=$check_usuario->query("SELECT dep_codigo FROM dependencia WHERE dep_codigo='$user_codigo_del' ");
